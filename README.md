...
```
cd existing_repo
git remote add origin https://10.10.11.80:3000/haodh-cads/cadswebfinance.git
git branch -M main
...
- [ ] [Set up project integrations](https://10.10.11.80:3000/haodh-cads/cadswebfinance/-/settings/integrations)
